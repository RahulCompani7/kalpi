    ...
    <motion.div ref={ref} className={cn("relative w-full max-w-4xl mx-auto h-full", className)}>
      <div className="absolute -left-4 md:-left-20 top-3">
        <motion.div
          ...
          className="ml-[27px] h-4 w-4 rounded-full border border-[#4A7C59] shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{
              duration: 0.2,
            ...
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? "#4A7C59" : "#4A7C59",
        ...
        <svg viewBox={`0 0 20 ${svgHeight}`} width="20" height={svgHeight} className="ml-4 block" aria-hidden="true">
          ...
          <defs>
            <motion.linearGradient id="gradient" gradientUnits="userSpaceOnUse" x1="0" x2="0" y1={y1} y2={y2}>
              <stop stopColor="#4A7C59" stopOpacity="0"></stop>
              <stop stopColor="#4A7C59"></stop>
              <stop offset="0.325" stopColor="#68B0AB"></stop>
              <stop offset="1" stopColor="#8FC0A9" stopOpacity="0"></stop>
